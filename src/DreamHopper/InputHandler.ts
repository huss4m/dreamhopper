...
import { Game, EnvironmentType } from "./Game"; // Import Game and EnvironmentType
...
export class InputHandler {
  ...
  private setupKeyboardControls(): void {
    ...
    this.scene.onKeyboardObservable.add((kbInfo) => {
      ...
      // Add 'U' to the list of tracked keys
      if (["Z", "S", "Q", "D", "A", "E", " ", "U"].includes(key)) {
        this.keyStates[key] = isDown;

        // Handle 'U' key press to switch to desert scene
        if (key === "U" && isDown) {
